...
function Renderer(canvasName, vertSrc, fragSrc) 
{
  ...
  function loadVertexData(filename) {
	...
	var data = new Float32Array(cubeProps.length);
    for(var k = 0; k < cubeProps.length; k++) data[k] = cubeProps[k];
  ...
  this.display = function () {
    ...
    gl.uniform1i(modeLoc, this.modeVal);
