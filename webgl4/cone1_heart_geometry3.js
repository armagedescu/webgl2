      ...
      for (let j = 0; j < slices; j++)
         for (let i = 0; i < sec2; i++)
         {
            ...
            //if (j == 1)
            {
               ...
               nverts [nv1]     =  s21[1];
               nverts [nv2]     = -s21[2];
               nverts [nv0 + 3] =  s21[0] + s21[3] / nv;
               nverts [nv1 + 3] =  s21[1] + s21[4] / nv;
               nverts [nv2 + 3] =  s21[2] - s21[5] / nv;
...
let func = () =>
{
   ...
   let drawNorms = gl.getUniformLocation(glCanvas.program, 'isDrawNorms');
